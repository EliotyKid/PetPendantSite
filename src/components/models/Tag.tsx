...
import { forwardRef, ComponentPropsWithoutRef, useEffect, useMemo } from "react";
...
const Tag = forwardRef<Group, CustomModelProps>(({ materialType, textureUrl, engravingText, ...props }, ref) => {
        ...
        >
           {textureUrl && (
             <ImageDecal 
               ...
               scale={[3.5, 3.5, .15]} // Retangular e profundo
               position={[.2, 0, 0]} 
             />
           )}
           {/* ... */}
