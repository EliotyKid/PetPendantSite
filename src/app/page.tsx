  ...
  return (
    <main className="w-svw">
            ...
            <div className="max-w-5xl w-full flex flex-col gap-8 items-center text-center mt-32 md:mt-0">
              ...
              >
                <p className="text-lg md:text-xl text-secondary max-w-lg leading-relaxed font-montserrat ">
                  Handcrafted custom jewelry from your best friend's photo. Keep
                  them by your side forever in Gold, Silver, or Rose Gold.
                </p>
                ...
                <div className="flex flex-col md:flex-row gap-4 w-full md:w-auto">
                  <Link href="/customize">
                    <Button
                      size="lg"
                      className="rounded-full px-8 text-base cursor-pointer"
                    >
                      Start Customizing
                    </Button>
                  </Link>
      ...
      <section className="bg-secondary w-full flex flex-col items-center justify-center">
        <div className="py-24 md:py-40 max-w-7xl w-full bg-secondary/40 backdrop-blur-xl flex flex-col gap-16 md:gap-24 px-10">
          <div className="flex flex-col">
            <motion.h2
              ...
              className="text-black text-6xl sm:text-7xl md:text-9xl font-bold tracking-tighter leading-[0.9] text-center md:text-left"
            >
              READY TO <br />
              <span className="text-base">IMMORTALIZE?</span>
            </motion.h2>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center md:items-end gap-8 md:gap-0">
            ...
            >
              Don't let the memory fade. Turn your favorite photo into a
              heirloom that lasts forever.
            </motion.p>
          </div>
        </div>
        {/* <div className="py-24 md:py-40 max-w-7xl w-full bg-secondary/40 backdrop-blur-xl " />
